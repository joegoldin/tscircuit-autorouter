      ...
      (cms) => [
        {
          ...
          nodeAssignmentMargin: cms.srj.defaultObstacleMargin ?? cms.srj.minTraceToPadEdgeClearance ?? 0.2,
        },
      ],
    ),
    definePipelineStep(
      ...
      (cms) => [
        {
          ...
          obstacles: cms.srj.obstacles,
          colorMap: cms.colorMap,
          repairMargin: cms.srj.defaultObstacleMargin ?? cms.srj.minTraceToPadEdgeClearance ?? 0.2,
          maxSampleEntries: 80,
        },
      ],
    ),
